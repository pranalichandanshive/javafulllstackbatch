...
class EmpComparatorImpl{
    public static void main(String[] args) {
        Employee e1 = new Employee("Prajakta", "EMP-001", 23, 600000);
        Employee e2 = new Employee("Pranali", "EMP-002", 24, 167000);
        Employee e3 = new Employee("Janhavi", "EMP-003", 18, 1000000);
        ...
        Collections.sort(employees, new EmpSalaryComparator().reversed());
